...
const en: Dict = {
  ...
  "dash.edit": "Edit link",
  "dash.delete": "Delete link",
  "dash.confirmDelete": "Delete /{code}? This can't be undone.",
  "dash.editPrompt": "New destination URL:",
  "dash.detailToggle": "Click stats",
  "dash.detail7d": "Last 7 days",
...
const tr: Dict = {
  ...
  "dash.colActions": "İşlem",
  "dash.edit": "Linki düzenle",
  "dash.delete": "Linki sil",
  "dash.confirmDelete": "/{code} silinsin mi? Geri alınamaz.",
  "dash.editPrompt": "Yeni hedef URL:",
  "dash.detailToggle": "Tıklama istatistiği",
  "dash.detail7d": "Son 7 gün",
...
const de: Dict = {
  ...
  "dash.colActions": "Aktionen",
  "dash.edit": "Link bearbeiten",
  "dash.delete": "Link löschen",
  "dash.confirmDelete": "/{code} löschen? Kann nicht rückgängig gemacht werden.",
  "dash.editPrompt": "Neue Ziel-URL:",
  "dash.detailToggle": "Klick-Statistik",
  "dash.detail7d": "Letzte 7 Tage",
...
const ar: Dict = {
  ...
  "dash.edit": "تعديل الرابط",
  "dash.delete": "حذف الرابط",
  "dash.confirmDelete": "حذف /{code}؟ لا يمكن التراجع.",
  "dash.editPrompt": "الرابط الهدف الجديد:",
  "dash.detailToggle": "إحصاءات النقر",
  "dash.detail7d": "آخر 7 أيام",
